...
\begin{figure}
    ...
    \caption{\label{fig:TC_fit}Plottet are the temperatures at which $\chi$ peaks for various lattice sizes. Fittet is a line according to eq.~(\ref{eq:bkt_scaling}).}
\end{figure}
\par
