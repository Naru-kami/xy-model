...
\noindent The two-dimensional XY model
with $J=1$ and spins $\theta_i \in [0, 2\pi)$ shows the Kosterlitz-Thouless (KT) transition at $T_c \approx 0.893$. Below $T_c$, bound vortex-antivortex pairs maintain long-range order; above $T_c$, they unbind, causing disorder.
